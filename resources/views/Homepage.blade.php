...
<body>
    ...
    <main class="content">
        ...
        <div class="product-grid">
            ...
            <!-- Card 3 -->
            <div class="product-card">
                <img src="images/rpl 3.jpg" alt="Kain Tenun Khas Kendari">
                <div class="card-info">
            ...
            <!-- Card 4 -->
            <div class="product-card">
                <img src="images/rpl 4.jpg" alt="Bagea">
                <div class="card-info">
                    <h3>Bagea</h3>
                    <p>Rp. 35,000</p>
                    <p>stok 50</p>
            ...
            <!-- Card 5 -->
            <div class="product-card">
                <img src="images/rpl 5.jpg" alt="Brownies Mete">
                <div class="card-info">
                    <h3>Brownies Mete</h3>
                    <p>Rp. 60,000</p>
                    <p>stok 35</p>
